 ...
 * `resolvedAnnotationClassIds` which forces lazy resolution to the TYPES phase and can fail
 * during SUPERTYPES.
 */
 ...
 * given `@MyAnnotation(replaces = [Foo::class, Bar::class])`, calling this with
 * `argName = "replaces"` returns `[ClassId(Foo), ClassId(Bar)]`.
 *
