 ...
 * replaced service's `MetroContribution` type and passes it in [MetroContributionExtension.Contribution.replaces]
 * so Metro removes the real service's contribution from the graph.
 */
