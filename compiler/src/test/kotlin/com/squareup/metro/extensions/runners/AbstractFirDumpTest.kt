...
import com.squareup.metro.extensions.services.FileSortingAssertionsService
...
open class AbstractFirDumpTest : AbstractFirLightTreeJvmIrTextTest() {
  ...
  override fun configure(builder: TestConfigurationBuilder) {
    ...
    with(builder) {
      // Sort // FILE: blocks alphabetically so IR dump golden files are stable across platforms.
      assertions = FileSortingAssertionsService
      ...
      defaultDirectives {
        ...
        // IR dump is NOT enabled by default. Add `// DUMP_KT_IR` to individual test files
        // to produce .fir.kt.txt golden files. Uses DUMP_KT_IR (not DUMP_IR) to avoid
        // machine-specific temp paths in the output.
